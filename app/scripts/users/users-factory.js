(function () {
  ...
  function checkUser() {
    ...
    if(Parse.User.current()){
      ...
      $('.login').html("<li><a href='#'><span class='entypo-home'></span>Home</a></li><li><a href='#/parent/"+ Parse.User.current().id+"'><span class='entypo-vcard'></span>My Profile</a></li><li><a href='' onClick='logOutUser()'><span class='entypo-logout'></span>Logout</a></li>");

    }

    else {

      $('.login').html("<li><a href='#'><span class='entypo-home'></span>Home</a></li><li><a href='#/login'><span class='entypo-login'></span>Login</a></li><li><a href='#/signup'><span class='entypo-pencil'></span>Sign Up</a></li>");
